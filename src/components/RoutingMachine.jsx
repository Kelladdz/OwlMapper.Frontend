...
import styles from './RoutingMachine.module.css'; // Zakładam, że styl masz już gotowy
      ...
      {createMarker: function(i, wp) {
        return L.marker(wp.latLng, {
          icon: L.divIcon({
            ...
            html: `<div class='${styles['outside-circle']}'><div class="${styles['inside-circle']}"></div></div>`,
            draggable: false
          })
...
const RoutingMachine = ({ routeLine, showLines }) => { 
